...
if (ReactionCore && ReactionCore.Hooks) {
  ReactionCore.Hooks.Events.add("onCoreInit", () => {
    ...
    ReactionImport.fixture().process(Assets.getText("data/Products.json"), ["title"], ReactionImport.load);
    ReactionImport.fixture().process(Assets.getText("data/Tags.json"), ["name"], ReactionImport.load);
